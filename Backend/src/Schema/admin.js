...
AdminSchema.pre("save", async function (next) {
  if (this.isNew) {
    ...
    if (count >= 3) {
      return next(new Error("Maximum 3 admins allowed"));
    }
  }
  next();
});
